...
function loadDefaultValues() {
  ...
  $("[id^=alt-][id$=-border-thickness]").prop(
    "checked",
    default_border_thickness
  );
  $("[id^=alt-][id$=-border-thickness-amount]").val(
...
for (var i = 0; i < more.length; i++) {
  more[i].onclick = function () {
    ...
    if (hideMore.style.maxHeight) {
      ...
      var hidable = document.getElementById("global-configuration").style
        .maxHeight;
      hidable = Number(hidable.replace(/px/g, ""));
      document.getElementById("global-configuration").style.maxHeight =
        hidable + hideMore.scrollHeight + "px";
    }
  };
}
...
var theme = localStorage.getItem("theme")
  ...
  : "dark";
$("head").append(
  '<link rel="stylesheet" href="../common/css/themes/' + theme + '/theme.css"/>'
);
...
$.each(themes, function (i) {
  ...
  $("#alt-main-config-content #theme").append(
    '<option name="' +
      themes[i] +
      '"' +
      $selected +
...
for (var i = 0; i < customFonts; i++) {
  ...
  $("#custom-font-list ul").append(
    '<li><div class="font-name-added slot-storable" id="font-name-added-' +
      font_number +
      '"></div><div class="font-url-added slot-storable" id="font-url-added-' +
      font_number +
...
function AddNewFont(font_name, font_url) {
  ...
  $(".font-storable").each(function () {
    $(this).append(
      '<option value="' + font_name + '">' + font_name_shortname + "</option>"
    );
  });
...
function removeFont(font_name, font_url) {
  ...
  $(".font-storable").each(function () {
    $(this)
      .children('option[value="' + font_name + '"]')
      .remove();
  });
}
  ...
  if (font_name_to_add && font_url_to_add) {
    ...
    $("#custom-font-list ul").append(
      '<li><div class="font-name-added slot-storable" id="font-name-added-' +
        howMany +
        '">' +
        font_name_to_add_clean +
        '</div><div class="font-url-added slot-storable" id="font-url-added-' +
        howMany +
        '">' +
        font_url_to_add_clean +
        '</div><div class="delete-font"><div class="icon icon-trash"></div></div></li>'
    );
    ...
    document.getElementById("global-configuration").style.maxHeight =
      hidable + 28 + "px";
    document.getElementById("more-settings").style.maxHeight =
      hidable + 28 + "px";
...
$("#custom-font-list ul").on("click", "li > .delete-font", function (e) {
  ...
  var font_name_to_remove = $(this)
    .closest("li")
    .children(".font-name-added")
    .text();
  var font_url_to_remove = $(this)
    .closest("li")
    .children(".font-url-added")
    .text();
